        ...
        <div className="container">
            <section className="documents__hero">
                ...
                <p className="documents__description">
                    Работаем официально, соблюдаем требования безопасности
                    и предоставляем полный комплект документов
                ...
                <article className="documents-card">
                    ...
                    <div className="documents-card__content">
                        ...
                        <p>
                            ...
                            и ремонт систем безопасности объектов.
                        </p>
                        <Link href="#">
                            Посмотреть документ →
                        </Link>
            ...
            <section className="documents__features">
                <article>
                    ...
                    <p>
                        Передаём заказчику исполнительную документацию
                        и обеспечиваем гарантийное сопровождение.
                    </p>
                </article>
                ...
                <article>
                    ...
                    <p>
                        Проводим регулярные проверки,
                        диагностику и восстановление систем.
                    </p>
                </article>
            ...
            <section className="documents__cta">
                <div>
                    ...
                    <p>
                        Подготовим необходимый пакет
                        документов и ответим на вопросы.
                    </p>
                </div>
