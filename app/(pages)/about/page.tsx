    ...
    <main className="about">
      ...
      <div className="container">
        <section className="about__hero">
          ...
          >
            ...
            <p className="about-text">
              Проектирование, монтаж и обслуживание инженерных систем безопасности. Комплексный
              подход для бизнеса и объектов.
            </p>
          </motion.div>
        </section>
        ...
        <motion.section
          ...
          viewport={{ once: true }}
        >
          <Heading mode="dark">О компании</Heading>

          <div className="about-grid">
            <article className="about-card about-image-wrapper">
              <Image src={smartSecurityImg} fill alt="Smart Security System" />
            </article>

            <article className="about-card">
              <h3>Кто мы</h3>
              <p className="about-text">
                ООО ПМО «Квадро-Арсенал» специализируется на создании комплексных решений
                безопасности.
              </p>
              <p className="about-text">
                Мы объединяем проектирование, монтаж оборудования и дальнейшее обслуживание
                объектов.
              </p>
            </article>
          </div>
        ...
        <section className="about-directions">
          <Heading mode="dark">Наши направления</Heading>
          ...
          <div className="about-directions__list">
            {directions.map((item, index) => (
              ...
              >
                <div className="direction-item__index">{String(index + 1).padStart(2, '0')}</div>
                <div className="direction-item__content">
                  <h3 className="direction-item__title">{item}</h3>
        ...
        <section className="about-team-air">
          <Heading mode="dark">Инженерная команда</Heading>
