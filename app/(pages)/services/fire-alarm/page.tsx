      ...
      <div className="container">
        <section className="service-hero">
          <div className="service-hero__content">
            ...
            <p>
              Создаём комплексные системы пожарной безопасности для коммерческих и промышленных
              объектов. От проекта до технического обслуживания.
            </p>
        ...
        <section className="service-section">
          <Heading mode="dark">Пожарная сигнализация</Heading>

          <div className="service-text">
            <p>
              Система пожарной сигнализации предназначена для своевременного обнаружения признаков
              возгорания и передачи сигнала о пожаре.
            </p>
            <p>
              Решения разрабатываются с учётом назначения объекта, особенностей здания и требований
        ...
        <section className="service-section">
          ...
          <div className="service-regulations">
            <p>
              При проектировании и монтаже систем безопасности руководствуемся требованиями
        ...
        <section className="service-section">
          ...
          <div className="service-timeline">
            {stages.map((item, index) => (
              <div className="service-timeline__item" key={item}>
                <div className="service-timeline__number">{index + 1}</div>
                <p>{item}</p>
              </div>
            ))}
          </div>
