...
import lowCurrentImage from '@/app/_assets/images/services/low-current-systems.webp';
...
import {
    ...
    workflowSteps,
    works
} from "@/app/(pages)/services/low-current-systems/low-current-systems.data";
            ...
            <div className="container">
                <section className="sp-hero">
                    ...
                    <div className="sp-hero__image">
                        <Image src={lowCurrentImage} alt="Слаботочные системы" fill priority/>
