...
export const FireDetectorIcon = ({
  size = 200,
  isActive,
  bulbColor = '#ff3b00',
}: IFireDetectorIconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 400" width={size} height={size}>
    ...
    {/* outer circle */}
    <circle cx="200" cy="200" r="180" fill="#ffffff" stroke="#000000" strokeWidth="6" />

    {/* inner circle */}
    <circle cx="200" cy="200" r="120" fill="#ffffff" stroke="#00000095" strokeWidth="6" />
