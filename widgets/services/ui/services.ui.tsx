  ...
  return (
    <section className="services">
      <div className="services__container">
        <SectionHeader eyebrow="Основные направления" title="Услуги компании" />
      </div>

      <div className="services__list">
        {services.map((item, index) => (
          <article key={item.id} className={`service ${index % 2 !== 0 ? 'service--reverse' : ''}`}>
            <div className="service__media">
              <Image src={item.image} alt={item.title} fill className="service__image" />
