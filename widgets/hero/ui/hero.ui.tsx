      ...
      <div className="main">
        ...
        <div className="main__wrap">
          <div className="main__left">
            {!isMobile && <Logo />}
            {isMobile && <h2 className="promo-heading">Наши услуги</h2>}
          ...
          <div className="main__right">
            <span className="promo-eyebrow">Проектирование и монтаж</span>
            <h2 className="promo-heading">Системы безопасности для бизнеса и объектов</h2>
            <p className="promo-text">
              Проектируем, монтируем и обслуживаем системы безопасности для предприятий и объектов.
              Работаем в Электростали и Московской области. Берем на себя весь цикл — от
              обследования до круглосуточного мониторинга.
            </p>
