            ...
            <div className="footer__grid">
                <div className="footer__brand">
                    ...
                    <p className="footer__description">
                        Проектирование, монтаж и обслуживание систем безопасности для бизнеса,
                        предприятий и частных объектов.
                    </p>
                </div>
                ...
                <nav className="footer__column">
                    ...
                    <div className="footer__row">
                        ...
                        <Link href={account.href} className="link">{account.title}</Link>
                    </div>
                </nav>
