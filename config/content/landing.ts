...
export const landing = {
    ...
    cta: {
        eyebrow: "Контакты",
        title: "Нужна система безопасности для объекта?",
        text: "Подберем решение под задачи предприятия, офиса или частного объекта. Работаем по Электростали и Московской области.",
        btn_secondary: "Контакты",
        link_map_label: "Открыть адрес компании на Яндекс Картах",
        image_map_label: "Расположение офиса Квадро-Арсенал",
        map_label: "Мы на Яндекс Картах",
        map_text: "Построить маршрут"
    }
}